            ...
            <div className="flex flex-col justify-center gap-3 items-center ">
              <div className="flex items-center gap-2">
                <a href="https://www.instagram.com/elitek9worldwide/?igshid=1nda2zqnahtl3">
                  <AiFillInstagram className="hover:text-theme_gold text-2xl active:scale-95 w-10 h-10" />
                </a>
                <a href="https://www.youtube.com/channel/UCNleC5A1XMzovfinK7PXk7g">
                  <AiFillYoutube className="hover:text-theme_gold text-2xl active:scale-95 w-10 h-10" />
                </a>
                <a href="https://www.tiktok.com/@elitek9international?_t=ZM-8uiWSel48Ck&_r=1">
                  <AiFillTikTok className="hover:text-theme_gold text-2xl active:scale-95 w-10 h-10" />
                </a>
                <a href="https://www.facebook.com/share/1BQJiG27cF/">
                  <CgFacebook className="hover:text-theme_gold text-2xl active:scale-95 w-10 h-10" />
                </a>
              </div>
            </div>
          </div>
